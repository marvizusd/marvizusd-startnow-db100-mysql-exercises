...
describe('SQL Exercises -', function () {
  ...
  describe('WHERE clause -', () => {
    ...
    it('3c. Select payments made on 05/27/2005', () => {
      gradeExercise(results[8], 145, 'payment_id', 'amount', 'payment_date');
    });
  ...
  describe('BETWEEN operator -', () => {
    ...
    it('5b. Select films with a description length between 100 and 120', () => {
      gradeExercise(results[18], 262, 'title', 'description', 'release_year', 'rental_rate', 'replacement_cost', 'rental_duration');
    });
  }); 
