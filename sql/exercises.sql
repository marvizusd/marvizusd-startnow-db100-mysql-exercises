...
# 3c. Select the primary key, amount, and payment date columns from the payment table for payments made on 05/25/2005.

SELECT payment_id, amount, payment_date FROM payment WHERE payment_date BETWEEN '2005-05-24' AND '2005-05-26';
...
SELECT * FROM customer WHERE active<"1" OR last_name LIKE "%m";
...
SELECT * FROM category WHERE category_id >4 AND name LIKE "c%" UNION SELECT * FROM category WHERE category_id >4 AND name LIKE "s%" UNION SELECT * FROM category WHERE category_id >4 AND name LIKE "t%";
...
SELECT payment_id, amount, payment_date FROM payment WHERE payment_date BETWEEN "2005-05-25 00:00:00" AND "2005-05-25 23:59:59" UNION SELECT payment_id, amount, payment_date FROM payment WHERE payment_date BETWEEN "2005-05-27 00:00:00" AND "2005-05-27 23:59:59" UNION SELECT payment_id, amount, payment_date FROM payment WHERE payment_date BETWEEN "2005-05-29 00:00:00" AND "2005-05-29 23:59:59";
...
SELECT title, description, release_year, rental_duration, rental_rate, replacement_cost FROM film WHERE char_length(description) BETWEEN 100 AND 120;
...
SELECT title, description, release_year FROM film WHERE description LIKE "A_Thoughtful%";
...
SELECT title, length, description,rental_rate FROM film WHERE length >= 180 AND description LIKE "%database%";
...
SELECT payment_id, payment_date, amount FROM payment WHERE amount > 5;
...
SELECT * FROM film WHERE length < 120 AND special_features LIKE "behin%" AND rental_duration BETWEEN 5 AND 7 ORDER BY length DESC LIMIT 10;
